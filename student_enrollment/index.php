  ...
  <body>
    <div class="container"><br>
      <a class="btn btn-primary float-right" href="admin/login.php">Login</a>
          <h1 class="text-center">Welcome to the SDN Kotalama 1 Management System!</h1><br>
          ...
          <div class="row">
            ...
            <table class="text-center infotable">
              ...
              <tr>
                ...
                <td>
                  <input class="form-control" type="text" pattern="[0-10]{10}" id="roll" placeholder="Roll Num.." name="roll">
                </td>
              </tr>
              <tr>
