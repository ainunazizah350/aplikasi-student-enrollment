	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact" value="<?php echo $row['pcontact']; ?>" pattern="08[5|6|7|8|9][0-9]{8}" placeholder="08........." required="">
	  	</div>
	  	<div class="form-group">
		    ...
		    <select name="class" class="form-control" id="class" required="" value="">
				...
				<option value="6th" <?= $row['class']=='6th'? 'selected':'' ?>>6th</option>
		    </select>
	  	</div>
	  	<div class="form-group">
